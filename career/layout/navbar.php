    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="../index.php"><img src="img/logo_typo.png"></a>
            </div>
            ...
            <div class="collapse navbar-responsive-collapse navbar-collapse" id="bs-navbar">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li >
                        <a class="page-scroll" href="#animator">Animator</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#director">Content Strategist</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#teacher">Teacher</a>
                    </li>
