        <div id="pembahasan" class="tab-pane">
            ...
            <div id="1" class="tab-pane active">
                ...
                <div class="bottom-radius-narrow row left-padding right-padding  white-bg top-padding-narrow bottom-padding-narrow">
                    <div class="col-sm-12 col-md-12 text-left padding-bottom-narrow">
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 2</h4>
                    <p  class="font-green text-justify ">
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 3</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-1.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 4</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-2.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 5</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-1.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 6</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-2.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 7</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-1.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 8</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-2.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 9</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-1.txt'); ?>
                    <br>
                    <br>
                ...
                <div class="top-padding-narrow latihan row left-padding right-padding  grey-bg ">
                    <h4 class="text-left bold">Pembahasan Soal Nomor 10</h4>
                    <p  class="font-green text-justify ">
                    <?php include ('soal-2.txt'); ?>
                    <br>
                    <br>
                ...
                <?php include ('pages/tryout1/layout/socmed-2.php') ?>
                <div class="row top-green-border bottom-green-border ">
                    ...
                    <div class="col-sm-12 col-md-6 text-center">
                        ...
                        UNDUH SOAL DAN PEMBAHASAN<i class="social-icon-2 fa fa-download"></i></a>
                    </div>  
            ...
            <!--div id="2" class="tab-pane">
                ...
                <div class="bottom-radius-narrow row left-padding right-padding  white-bg top-padding-narrow bottom-padding-narrow">
                    <div class="col-sm-12 col-md-4 text-left padding-bottom-narrow">
                        <a id="option-1" href="#"  onclick="select1()" class="yell-bg option padding-all-narrow btn btn-primary btn-xl ">
                        <i class="fa fa-check-square-o"></i> Pilihan 1</a>
                    </div>
                    <div class="col-sm-12 col-md-4 text-left bottom-padding-narrow">
                ...
                <div class="bottom-radius-narrow row left-padding right-padding  white-bg top-padding-narrow bottom-padding-narrow">
                    <div class="col-sm-12 col-md-4 text-left padding-bottom-narrow">
                        <a id="option-1" href="#"  onclick="select1()" class="yell-bg option padding-all-narrow btn btn-primary btn-xl ">
                        <i class="fa fa-check-square-o"></i> Pilihan 8</a>
                    </div>
                    <div class="col-sm-12 col-md-4 text-left bottom-padding-narrow">
                        <a id="option-2" href="#"  onclick="select2()" class="red-bg option padding-all-narrow btn btn-primary btn-xl ">
                        <i class="fa fa-square-o"></i> Pilihan 2</a>
